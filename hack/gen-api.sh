...
curl -s "${ESPNAPI}" | gojson -name=League -pkg=generated -o ${REPO_ROOT}/pkg/api/v3/generated/League.go
...
echo -e "// This file is generated by running \`make generateAPI\`\n$(cat ${REPO_ROOT}/pkg/api/v3/generated/League.go)" > ${REPO_ROOT}/pkg/api/v3/generated/League.go
